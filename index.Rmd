...
author:
- name: Demian Zayat
  affiliation: Universidad de Buenos Aires - Facultad de Derecho 
  description: Sitio del curso 0511 UBA Derecho - 1er bimestre 2do cuatrimestre 2021 Ma-Vi 10:11.30hs
---
...
### `r advdate(viernes, 1)`. Unidad 1. Estándares internacionales
...
### `r advdate(martes, 2)`. Unidad 2. Concepto clásico y estructural
...
### `r advdate(viernes, 2)`. Unidad 3. La Agenda estructural
...
### `r advdate(martes, 3)`. Unidad 3. La práctica
...
- Dicen que tuve un bebé, [Selección](https://drive.google.com/file/d/11CkDJsJytes8lsTh1XaulrLOuNEknJel/view?usp=sharing), presentado por Natalia Saralegui.
...
### `r advdate(viernes, 7)`. Unidad 4. Litigio Constitucional

Estándares de la Corte Suprema para facilitar el acceso a la justicia: *Persepectiva clásica*
...
- Paula Sagel, El Poder Judicial frente al derecho al aborto, [aca](https://drive.google.com/file/d/1vMvD_z6aXP-I36tmDweFL6uaWI6k2xcC/view?usp=sharing)


### `r advdate(martes, 8)`. Unidad 3. La práctica
...
Estándares de la Corte Suprema para facilitar el acceso a la justicia: *Persepectiva estructural*
